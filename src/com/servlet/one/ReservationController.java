...
protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		// 프로모션 등록 결과 확인
		boolean insertCheck = rDao.reservationInsertManager(rDto);
		if (insertCheck) {
            // 프로모션 추가 성공 시, 다시 PromotionList.jsp로 이동
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	    ...
	    // 요청 파라미터 받아오기
		String usercodeString = request.getParameter("usercode");//문자열로 받음
	    ...
	    MemberDTO member = memberDAO.getMemberByUserCode(usercode);
