...
<body>
   ...
   <div id="menu">
      <a href="./MyPage_Member.jsp">내 정보 보기/수정</a> <a
         href="./MyPage_Reservation.jsp">내 예약 관리</a>
   </div>
   <div id="reservation"
   ...
   <div id="member"
      ...
      <div style="margin-left: 20px;">
         <input type='button' value='여행지 목록 확인' onclick="showDestinationList()" />
         <input type='button' value='프로모션 확인' onclick="showPromotionList()" />
      </div>
      <div style="margin-left: 20px;">
         <input type='button' value='내 예약 보기' onclick="contentToggle('reservationlook')" /> 
         <input type='button' value='예약 추가하기' onclick="contentToggle('reservationadd')" /> 
         <input type='button' value='내 예약 수정하기' onclick="contentToggle('reservationchange')" /> 
         <input type='button' value='내 예약 취소하기' onclick="contentToggle('reservationdelete')" />
      </div>
   </div>
   <!-- 내 정보 보기 -->
   <div id="reservationlook" class="content"
      ...
      <table id="registrationForm1" width="70%" border="1">
         <form name="regForm" method="post" action=""
            onsubmit="return submitForm(this, 'memberlook');">
            ...
            <tr>
               ...
               <td width="70%"><input type="text" id="checkPassword"
                  name="password" size="15" placeholder="패스워드"><br> <input
                  type="button" value="내 정보 확인하기" onclick="checkCredentials0()" />
                  <input type="button" value="내 예약 확인하기"
   ...
   <div id="reservationadd" class="content"
      style="margin-bottom: 20px; margin-left: 20px; float: center; width: 70%;">
      <div id="additionalFields10"></div>
      <!-- 사용자 코드 확인 입력시 작동 -->
      <div id="additionalFields11"></div>
      <!-- 여행지 코드 확인 입력시 작동 -->
      <div id="additionalFields12"></div>
      <!-- 프로모션 코드 확인 입력시 작동 -->
      <table id="registrationForm1" width="70%" border="1">
         <form name="regForm" method="get"
            ...
            <tr>
               ...
               <td width="70%">
                  <input type="text" id="checkUserCode" name="usercode" size="15">
                  </td>
            </tr>
			<tr> 
            ...
            <tr>
               <td width="30%">여행지 코드</td>
               	  <td width="70%"><input type="text" id="checkDsCode" name="dscode" size="15">
                  <input type="button" value="확인하기" onclick="checkCredentials11()" /></td>
            </tr>
            <tr>
               <td width="30%">프로모션 코드(없다면 디폴트인 1을 넣을 것)</td>
               <td width="70%">
                  <input type="text" id="checkPrmCode" name="prmcode" size="15">
                  <input type="button" value="확인하기" onclick="checkCredentials12()" /></td>
            </tr>
            <tr>
               <td width="30%">가격(여행지 가격)</td>
               <td width="70%"><input type="text" id="insertFiPrice" name="fiprice" size="15">
            </tr>
            <tr>
               <td width="30%">날짜</td>
               <td width="70%"><input type="text" id="insertDate" name="date" size="15">
            </tr>
            <tr>
               <td colspan="2" align="center">
               	  <input type="submit" value="예약 추가" onclick="contentToggle('reservationadd')"> 
   ...
   <!-- 내 정보 수정하기 -->
   <div id="reservationchange" class="content" style="margin-bottom: 20px; margin-left: 20px; float: center; width: 70%;">
      <form name="regForm" method="get" action="/MyWebSite/ReservationChangeController"
         ...
         <table width="70%" border="1">
            <tr align="center" bgcolor="#0056b3">
               <td colspan="2">
                  <!-- 변경된 부분 --> <font color="#FFFFFF"><b>수정하고자 하는 예약의
                        여행지 코드와 프로모션 코드를 입력하세요.</b></font>
               </td>
            </tr>
            <tr>
               <td width="30%">아이디</td>
               <td width="70%"><input type="text" id="checkId1" name="id"
                  size="15" placeholder="아이디"></td>
            </tr>
            <tr>
               <td width="30">패스워드</td>
               <td width="70%"><input type="text" id="checkPassword1" name="password" size="15" placeholder="패스워드"><br> 
                  <input type="button" value="내 정보 확인하기" onclick="checkCredentials2()" />
                  <input type="button" value="내 예약 확인하기" onclick="checkCredentials3()" />
               </td>
            </tr>
            <tr>
               <td width="30%">사용자 코드</td>
               <td width="70%"><input type="text" id="checkUserCode1" name="usercode" size="15"></td>
            </tr>
            <tr>
               <td width="30%">예약 코드</td>
               <td width="70%"><input type="text" id="checkRvCode1" name="rvcode" size="15">
               </td>
            </tr>
            <tr>
               <td width="30%">여행지 코드</td>
               <td width="70%"><input type="text" id="checkDsCode1" name="dscode" size="15">
               <input type="button" value="확인하기" onclick="checkCredentials4()" /></td>
            </tr>
            <tr>
               <td width="30%">프로모션 코드(없다면 디폴트인 1을 넣을 것)</td>
               <td width="70%"><input type="text" id="checkPrmCode1" name="prmcode" size="15">
               <input type="button" value="확인하기" onclick="checkCredentials5()" /></td>
            </tr>
            <tr>
               <td width="30%">가격(여행지 가격)</td>
               <td width="70%"><input type="text" id="insertFiPrice1" name="fiprice" size="15">
            </tr>
            <tr>
               <td width="30%">날짜</td>
               <td width="70%"><input type="text" id="insertDate1" name="date" size="15">
            </tr>
            <tr>
               <td colspan="2" align="center">
               	  <input type="submit" value="내  예약 수정하기" onclick="contentToggle('reservationchange')">
                  <input type="reset" value="다시쓰기"></td>
            </tr>
         </table>
   </div>
   <div id="reservationdelete" class="content"
      ...
      <form name="regForm3" method="get"
         ...
         <table id="registrationForm1" width="70%" border="1">
            <tr align="center" bgcolor="#0056b3">
               <td colspan="2"><font color="#0056b3"><b>내 예약 삭제하기</b></font></td>
            </tr>
            <tr>
               <td width="30%">예약 코드</td>
   ...
   <script>
      ...
      function checkCredentials1() {
         ...
         $.ajax({
            type : "POST",
            url : "/MyWebSite/ReservationMyPageController",
            data : {
               id : id
            },
            success : function(data) {
    ...
    //예약 추가하기에서 프로모션 코드(prmcode)를 입력하고 확인 버튼을 눌렀을 때
      ...
      //예약 수정하기에서 예약 코드(rscode)를 입력하고 확인 버튼을 눌렀을 때
      function checkCredentials6() {
         var rvcode = $("#checkRvCode1").val();
